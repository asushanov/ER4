...
**
** Created: Wed Mar 30 00:17:40 2011
...
static const char qt_meta_stringdata_MyTab[] = {
    "MyTab\0"
};

const QMetaObject MyTab::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MyTab,
      qt_meta_data_MyTab, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyTab::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyTab))
